...
public class BehaviorTests
{
    ...
    [Fact]
    public async Task LoggingBehavior_Should_Log_Errors_And_Redact_Message_By_Default()
    {
        // Arrange
        var logger = new FakeMediatorLogger();
        var behavior = new Behaviors.LoggingBehavior<LoggedRequest, string>(logger);
    ...
    [Fact]
    public async Task LoggingBehavior_Should_Log_Errors_With_Message_When_Configured()
    {
        // Arrange
        var logger = new FakeMediatorLogger();
