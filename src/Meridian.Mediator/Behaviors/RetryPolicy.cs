...
public static class RetryPolicy
{
    ...
    internal static Func<double> JitterProvider { get; set; } = static () => System.Security.Cryptography.RandomNumberGenerator.GetInt32(0, int.MaxValue) / (double)int.MaxValue;
